...
} from '../../../gombook/src/lib/store/adminUserStore';
import { storeUser, storeUserActions } from '../../../gombook/src/lib/store/userStore';
...
export const useAuth = () => {
  ...
  const adminAuthCheck = () => {
    ...
    if (adminUserInfo && adminAuth) {
      let adminUser: AuthUser | null = JSON.parse(adminUserInfo);
